...
{
    [TestClass]
    public class Variable64bitBlockTests
    {
        byte[] key = new byte[] { 0x20, 0x36, 0xac, 0x45, 0xd0 };
        [TestMethod]
        public void Var_UInt64_64Bit_Min()
        {
            ...
            encryptor.Encipher(payload, payload.Length, 64);
            ...
            decryptor.Decipher(payload, payload.Length, 64);
        ...
        [TestMethod]
        public void Var_UInt64_64Bit_Max()
        {
            const ulong sourceValue = ulong.MaxValue; // 64-bit int MaxValue
            ulong encryptedValue = ulong.MinValue;
            ulong targetValue = ulong.MaxValue;
        ...
        [TestMethod]
        public void Var_UInt64_64Bit_Mixed()
        {
        ...
        [TestMethod]
        public void Var_UInt64_64Bit_Multiple_Blocks()
        {
